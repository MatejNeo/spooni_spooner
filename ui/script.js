...
function openDatabase(data,filter) {
	currentData = data;
...
window.addEventListener('load', function() {
	...
	document.querySelector('#yes-delete-db').addEventListener('click', function(event) {
		document.querySelector('#delete-db-prompt').style.display = 'none';
		sendMessage('deleteDb', {
			name: currentDeletionSelection.innerHTML
		});
		currentDeletionSelection.remove();
	});
		
	document.querySelector('#no-delete-db').addEventListener('click', function(event) {
		document.querySelector('#delete-db-prompt').style.display = 'none';
	});
